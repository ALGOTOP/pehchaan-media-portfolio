...
export default function Showreel() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-center text-[3.5rem] md:text-[6rem] font-display font-extrabold uppercase tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 drop-shadow-[0_0_10px_rgba(56,189,248,0.25)]">
          Stories in Motion
        </h2>
