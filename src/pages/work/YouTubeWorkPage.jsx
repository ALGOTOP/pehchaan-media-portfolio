...
export default function YouTubeWorkPage() {
  ...
  return (
    <WorkCategoryLayout
      title="YouTube (Thumbnails & Editing)"
      description="YouTube channel design: thumbnails, editing, and short-form repurposing strategies that increase CTR."
      heroImage={heroImage}
    >
      <WorkReel items={reel} />
